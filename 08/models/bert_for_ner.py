...
# Softmax 的 NER 模型， Bert(last hidden state) + Classifier
...
# CRF 的 NER 模型， Bert(last hidden state) + Classifier + CRF
...
# Span 的 NER 模型， Bert(last hidden state) + Classifier + Span(start, end)
