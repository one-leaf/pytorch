...
class Train():
    def __init__(self):
        ...
        self.n_playout = 256  # 每个动作的模拟战记录个数，不能用32，因为收敛太慢了
    ...
    def collect_selfplay_data(self):
        ...
        # 同时开两个游戏
        game_copy = copy.deepcopy(agent)
        games = (agent, game_copy)
        ...
        for i in count():
            ...
            action, move_probs, state_value = player.get_action(games, curr_player, temp=1) 
