...
class MCTS():
    ...
    def get_action_probs(self, games, curr_player, temp=1):
        ...
        if game.show_mcts_process or game.pieceheight in [0, game.max_height] :
            ...
            print(game.steps, game.fallpiece["shape"], "temp:", round(temp,5), "ns:", ns, "depth:", self.max_depth,"height:", game.pieceheight, "value:", round(v,2), "qval:", round(qval,2), info, "player:", self.curr_player)
