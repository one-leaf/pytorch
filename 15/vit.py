...
class VitNet(nn.Module):
    def __init__(self,  embed_dim=768, drop_ratio=0.5, drop_path_ratio=0.5, depth=12, num_heads=12, 
                        mlp_ratio=4.0, qkv_bias=True, qk_scale=None, attn_drop_ratio=0.5, num_classes=1000):
