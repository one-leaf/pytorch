...
class FiveChessTrain():
    def __init__(self):
        ...
        self.c_puct = 0.001  # MCTS child权重， 用来调节MCTS中 探索/乐观 的程度 默认 5
    ...
    def collect_selfplay_data(self):
        ...
        if r>0.9:
            ...
            pure_mcts_player = MCTSPlayer(self.policy_value_net.policy_value_fn, c_puct=5, n_playout=self.n_playout, is_selfplay=1)
