...
class Train():
    ...
    def collect_selfplay_data(self):
        ...
        for i in count():
            ...
            if games[0].piececount==games[1].piececount:
                if game.pieceheight>=6 or abs(games[0].pieceheight-games[1].pieceheight)>=3:
                    game_stop=True
        ...
        if games[0].pieceheight>4 and games[1].pieceheight>4 and (games[0].score+games[1].score<2*result["total"]["reward"]): winner = -1
