...
class Train():
    ...
    def collect_selfplay_data(self):
        ...
        player = MCTSPlayer(policy_value_net.policy_value_fn, c_puct=self.c_puct, n_playout=self.n_playout, limit_count=self.sample_count, piececount_mcts=state["total"]["piececount"])
