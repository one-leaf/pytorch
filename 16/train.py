...
class Train():
    ...
    def run(self):
        ...
        try:
            ...
            begin_act_probs_e = np.exp(begin_act_probs)
            begin_act_probs = begin_act_probs_e/np.sum(begin_act_probs_e, axis=1)
            end_act_probs_e = np.exp(end_act_probs)
            end_act_probs = end_act_probs_e/np.sum(end_act_probs_e, axis=1)
