...
class MCTSPlayer(object):
    ...
    def get_action(self, game, temp=0, dirichlet_p=0):        
        ...
        if not game.terminal:  # 如果游戏没有结束
            ...
            # if game.steps%2==0 and self.player==0 : idx = max_ps_idx
            # elif game.steps%2==1 and self.player==1 : idx = max_ns_idx
            ...
            if idx!=max_ns_idx:
                print("          {} random: {} ==> {} v: {} ==> {} p: {} ==> {} probs: {}".format(self.player, game.position_to_action_name(max_ns_idx), \
            ...
            return action, qval, act_probs, act_ps, state_v, acc_ps, depth, find_end
        else:
