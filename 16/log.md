...
| 20.1  | 62    | 12    | 0.01  | 0.07  | 0.55  | 2370  | 63    | 11 12 10  | 64    | std(q) | std(gae(q-x))  | p - old_p  | a + p + v - n | 0.5   | 0.99   |

# 失败 a=std(gae(Δq)) v=0.999**i-1
| 21.1  | 153   | 15    | 0     | 0.02  | 0.21  | 1880  | 119   | 14 13 21  | 64    | 0 ~ -1 | std(gae(Δq)) | p - old_p  | a + p + v - n |   5   | 0.99   |
...
# doing v=std(q-Δq) a=-std(gae(Δq))
| 21.1  | 109   | 13    | 0     | 0.26  | 0.60  | 1093  | 103   | 13 13 11  | 64    | std(q) | std(gae(Δq)) | p - old_p  | a + p + v - n | 0.5   | 0.99   |

# nexting a = std(gae(q-[1~-1]))
| 21.1  | 109   | 13    | 0     | 0.26  | 0.60  | 1093  | 103   | 13 13 11  | 64    | std(q) | std(gae(Δq)) | p - old_p  | a + p + v - n | 0.5   | 0.99   |
