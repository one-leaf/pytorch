...
class MCTS():
    ...
    def get_action_probs(self, game, temp=1, avg_ns=0):
        ...
        if game.show_mcts_process or game.state == 1 :
            ...
            print(game.steps, game.fallpiece["shape"], "temp:", round(temp,2), "ns:", ns, "/", test_count, "depth:", self.max_depth, "empty:", game.emptyCount, "height:", round(game.pieceheight,2), "value:", round(v,2), info)
