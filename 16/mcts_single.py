...
class MCTS():
    ...
    def get_action_probs(self, game, temp=1):
        ...
        if game.show_mcts_process or game.state == 1 :
            ...
            print(game.steps, game.fallpiece["shape"], "temp:", round(temp,2), "ns:", ns, "depth:", self.max_depth, "empty:", game.getEmptyCount(), "height:", round(game.pieceheight,2), "value:", round(v,2), "qval:", round(qval,2), info, "std:", round(game.getHeightDiff(),4))
    ...
    def search(self, game):
        ...
        if game.terminal: 
            self.Es[s] = game.prev_EmptyCount - game.emptyCount + game.prev_pieceheight - game.pieceheight + game.prev_heightDiff - game.heightDiff - 1
        ...
        # 现实奖励
        if game.state == 1 and game.prev_pieceheight<10 and game.piececount - game.prev_piececount > 1:
