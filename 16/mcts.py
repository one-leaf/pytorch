...
class MCTS():
    ...
    def get_action_probs(self, games, curr_player, temp=1):
        ...
        if game.show_mcts_process or game.state == 1:
            ...
            print(game.steps, game.fallpiece["shape"], "temp:", round(temp,2), "ns:", ns, "depth:", self.max_depth,"height:", round(game.pieceheight,2), "value:", round(v,2), "qval:", round(qval,2), info, "player:", self.curr_player)
