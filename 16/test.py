...
def test():
    x = [0.0273, 0.0153, 0.01, 0.008, 0.006, 0.004, 0.002, 0.0075, 0.0, 0.031, 0.0059, 0.005, 0.0362, 0.0032, 0.0017, 0.0, 0.0001, 0.0001, 0.0001, 0.00028, 0.00087, 0.00135, 0.00176, 0.00214, 0.00251, 0.00288, 0.00329]
    y = [0.555, 0.275, 0.268, 0.246, 0.283, 0.2982, 0.2781, 0.1591, 0.0995, -0.0245, -0.0891, -0.1445, 0.0259, -0.0126, 0.2382, 0.179, 0.2034, 0.3675, 0.2764, 0.1596, 0.076, 0.0075, -0.0357, -0.0798, -0.1127, -0.1357, -0.1531, -0.1644, -0.1727, -0.1717, -0.1867, -0.1988]
    x = np.array(x)
    y = np.array(y[-len(x):])
    # # 添加一列全为1的常数列作为截距
